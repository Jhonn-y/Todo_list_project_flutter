...
class TaskModule extends TodolistModule{
  TaskModule():super(routers: {
    '/task/create': (context) => TaskPage(controller: context.read(),),
  },
  bindings: [
    ...
    ChangeNotifierProvider(create: (context) => TaskController(tasksService: context.read()),)
  ]);
